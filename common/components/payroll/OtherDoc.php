...
{
    public static function BuktiPotong($year, $month, $period_code, $status_id, $user_id)
    {
...
GROUP BY pd.employee_id";
    ...
    public static function Formulir1721($year, $month, $period_code, $status_id, $user_id)
    {
