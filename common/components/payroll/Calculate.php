...
class Calculate extends Component
{
    public static function PayrollGenerateBatch($year, $month, $period_code, $status_id, $user_id)
    {
         ...
         * BPJS PERUSAHAAN
         */
        self::calculatePayrollCapParam($payroll_item_id=12, $generate_mode, $period_code, $status_id, $user_id); // JHT_PERUSAHAAN
        self::calculatePayrollCapParam($payroll_item_id=13, $generate_mode, $period_code, $status_id, $user_id); // JP_PERUSAHAAN
        self::calculatePayrollCapParam($payroll_item_id=14, $generate_mode, $period_code, $status_id, $user_id); // JKM
        self::calculatePayrollCapParam($payroll_item_id=15, $generate_mode, $period_code, $status_id, $user_id); // JKK
        self::calculatePayrollCapParam($payroll_item_id=16, $generate_mode, $period_code, $status_id, $user_id); // BPJS_KES_PERUSAHAAN


        /**
         * BPJS KARYAWAN
         */
        self::calculatePayrollCapParam($payroll_item_id=32, $generate_mode, $period_code, $status_id, $user_id); // JHT_KARY
        self::calculatePayrollCapParam($payroll_item_id=33, $generate_mode, $period_code, $status_id, $user_id); // JP_KARY
        self::calculatePayrollCapParam($payroll_item_id=34, $generate_mode, $period_code, $status_id, $user_id); // BPJS_KES_KARY
        ...
        // EMPLOYEE_BPJS_YEAR
        self::plusPayrollCategory($category_id=51, $generate_mode, $period_code, $status_id, $user_id);

        /**
         * BRUTO
         */
        self::plusPayrollCategory($category_id=26, $generate_mode, $period_code, $status_id, $user_id); // BRUTO
        self::plusPayrollCategory($category_id=49, $generate_mode, $period_code, $status_id, $user_id); // BRUTO_YEAR

        /**
         * BIAYA_JABATAN
         */
        self::calculatePayrollCapResult($payroll_item_id=50, $generate_mode, $period_code, $status_id, $user_id); // BIAYA_JABATAN
        ...
        // THP
        self::plusSignPayrollCategory($category_id=37, $generate_mode, $period_code, $status_id, $user_id);
    }
