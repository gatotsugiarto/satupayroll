...
/**
 * PayrollThrSearch represents the model behind the search form of `common\modules\payroll\models\PayrollThr`.
 */
class PayrollThrSearch extends PayrollThr
{
    /**
     * {@inheritdoc}
     */
