...
class AdditionalBenefitDetail extends ActiveRecord
{
    ...
    {
        return 'additional_benefit_detail';
    }
    ...
    public function behaviors()
    {
        ...
        return [
            ...
            'tokenProtection' => [
                ...
                'sessionKey' => 'additionalbenefitdetail_token',
            ],
            [
                'class' => LoggableBehavior::class,
                'modelName' => 'AdditionalBenefitDetail',
            ],
        ];
    }
    ...
    public function rules()
    {
        return [
            ...
            [['employee_id', 'display_order', 'profile_id', 'status_id', 'created_by', 'updated_by'], 'integer'],
            [['amount'], 'number'],
