...
<div class="d-flex justify-content-between align-items-center mb-2">
    ...
    <div>
        ...
        <?= Html::button('<i class="fa fa-plus"></i> Approve', [
            'class' => 'btn btn-success btn-sm rounded-pill shadow-sm create-data',
            'style' => 'min-width:160px;',
