...
$this->title = 'Detail '.'Additional Benefits';
$sub_title = "Overview of extra employee benefits.";
...
<div class="card shadow-sm border-0 rounded-4">
    <div class="card-body">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                <span class="text-secondary small">Month</span><br>
                <span class="fw-semibold">
                    <?php
                    $month = date('F', mktime(0, 0, 0, $model->month, 1));
                    ?>
                    <?= Html::encode($month) ?>
                </span>
            </div>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <span class="text-secondary small">Year</span><br>
                <span class="fw-semibold">
