...
$title = $isNew ? 'Create New AdditionalBenefitDetail' : 'Edit AdditionalBenefitDetail';
...
<div class="modal-header bg-default text-white rounded-top-4">
    <div>
        ...
        <small class="text-muted">
            <?= $isNew
                ? 'Please fill in the form below to register a new additionalbenefitdetail.'
                : 'Update additionalbenefitdetail information below.' ?>
        </small>
    </div>
</div>

<?php $form = ActiveForm::begin([
    'id' => 'additionalbenefitdetail-form',
    'enableAjaxValidation' => false,
    // 'validationUrl' => ['additionalbenefitdetail/validate'],
    'action' => $isNew ? ['additionalbenefitdetail/create'] : ['additionalbenefitdetail/update', 'id' => $model->id],
    'options' => ['data-pjax' => 0],
]); ?>
...
<div class="card shadow-sm border-0 rounded-4">
    <div class="modal-body px-4 pb-4">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <?= $form->field($model, 'source')->dropDownList([ 'DATA' => 'DATA', 'RATE' => 'RATE', 'FORMULA' => 'FORMULA', 'SUMMARY' => 'SUMMARY', 'META' => 'META', ], ['prompt' => '']) ?>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <?= $form->field($model, 'slip_display')->dropDownList([ 'Y' => 'Y', 'N' => 'N', ], ['prompt' => '']) ?>
            </div>
        </div>

        <div class="row">
            <div class="col-md-6">
                <?= $form->field($model, 'slip_position')->dropDownList([ 'C' => 'C', 'D' => 'D', 'S' => 'S', ], ['prompt' => '']) ?>
            </div>
