...
$title = $isNew ? 'Cancel THR' : 'Edit Payroll';
...
<div class="modal-header bg-default text-white rounded-top-4">
    <div>
        ...
        <small class="text-muted">
            <?= $isNew
                ? 'This action will cancel the selected THR period. Once cancelled, the THR cannot be processed unless it is revised or recreated.'
...
<?php $form = ActiveForm::begin([
    ...
    'action' => $isNew ? ['payrollthr/cancel'] : ['payrollthr/update', 'id' => $model->id],
    'options' => ['data-pjax' => 0],
]); ?>
