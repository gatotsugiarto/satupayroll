...
$title = $isNew ? 'Approve THR' : 'Edit Payroll';
...
<div class="modal-header bg-default text-white rounded-top-4">
    <div>
        ...
        <small class="text-muted">
            <?= $isNew
                ? 'This THR has received approval from the Finance department.'
...
<?php $form = ActiveForm::begin([
    ...
    'action' => $isNew ? ['payrollthr/approve'] : ['payrollthr/update', 'id' => $model->id],
    'options' => ['data-pjax' => 0],
]); ?>
