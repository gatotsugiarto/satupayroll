...
$subtitle = "Configure and oversee salary structures and compensation records.";
?>
...
<div class="d-flex justify-content-between align-items-center mb-2">
    ...
    <div>
        <?= ExportMenu::widget([
            ...
            'bsVersion' => '4',
            'bootstrap' => true,
            'filename' => 'Salary_Export_'.date('YmdHis'),
